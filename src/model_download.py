...
_FILES = {
    ...
    _ROOT / "pretrained_models/spkrec-ecapa-voxceleb/hyperparams.yaml": "hyperparams.yaml",
    ...
    _ROOT / "pretrained_models/spkrec-ecapa-voxceleb/label_encoder.txt": "label_encoder.txt",
    _ROOT / "pretrained_models/spkrec-ecapa-voxceleb/label_encoder.ckpt": "label_encoder.ckpt",
